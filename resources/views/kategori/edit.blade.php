...
@section('navbar')
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item text-sm text-dark" aria-current="page"><a class="opacity-5 text-dark" href="{{ route('buku.index') }}">Categories</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Category Update</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Category Update</h6>
        </nav>
            ...
            <div class="card-header pb-0 bg-transparent">
                <div class="row">
                    <div class="col-6 align-items-center">
                        <h3 class="font-weight-bolder text-info text-gradient">Category Update</h3>
                        <p class="text-danger mb-0 text-sm">(*) Wajib Diisi</p>
                    </div>
                    <div class="col-6 text-end">
                        <a class="btn bg-gradient-warning mb-0" href="{{ route('kategori.index') }}"><i class="fas fa-chevron-left me-2"></i>Back</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('kategori.update',$categories->id) }}" method="POST">
                    ...
                    @csrf
                    <div class="row">
                        <label>Nama Kategori<small class="text-danger ms-1">*</small></label>
                        <div class="mb-3">
                            <input type="text" class="form-control @error('category_name') is-invalid @enderror" value="{{$categories->category_name}}" name="category_name" placeholder="Nama Kategori" aria-label="category_name Buku" aria-describedby="category_name Buku-addon">
                            @error('category_name')
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0"><i class="fas fa-plus"></i>&nbsp;&nbsp;Update Category</button>
                    </div>
                </form>
            </div>
          </div>
