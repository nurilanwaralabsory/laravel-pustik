            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark" aria-current="page"><a class="opacity-5 text-dark"
                            href="{{ route('buku.index') }}">Categories</a></li>
            ...
            <div class="card-header pb-0 bg-transparent">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        <a class="btn bg-gradient-warning mb-0" href="{{ route('kategori.index') }}"><i
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control @error('category_name') is-invalid @enderror"
                                ...
                                placeholder="Nama Kategori" aria-label="category_name Buku"
                                aria-describedby="category_name Buku-addon">
                            @error('category_name')
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0"><i
                                    class="fas fa-plus"></i>&nbsp;&nbsp;Update Category</button>
                        </div>
                </form>
            </div>
        </div>
