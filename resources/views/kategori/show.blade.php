...
@section('navbar')
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
        ...
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Category Detail</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Category Detail</h6>
        </nav>
            ...
            <div class="card-header pt-4 pb-2">
                <div class="row">
                    <div class="col-6 d-flex align-items-center">
                      <h4 class="mb-0 text-primary text-gradient font-bold">Detail Kategori</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="table-responsive p-0 w-100">
                            ...
                            <thead>
                                <tr>
                                    <th class="w-0 text-uppercase text-dark text-sm font-weight-bolder opacity-7">Nama Kategori</th>
                                    <td class="w-0">:</td>
                                    <td>
                                        <h6 class="mb-0 text-sm">{{ $categories->category_name }}</h6>
                                    </td>
                                </tr>
                            </thead>
                            </table>
