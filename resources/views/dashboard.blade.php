            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="{{ route('admin') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white me-2 d-flex align-items-center justify-content-center">
                                ...
                                @foreach ($borrower as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-sm">
                                            <span class="text-xs font-weight-bold mb-0">{{ $item->books->title }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $item->borrow_date }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $item->return_date }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
