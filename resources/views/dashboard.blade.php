    ...
    <div class="row mt-4">
        ...
        <div class="card mb-4">
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                    <tr>
                        <th style="width: 10px" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"><span class="me-4">#</span>Nama</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <span class="text-secondary text-xs font-weight-bold">{{ $item->borrow_date }}</span>
                        </td>
                        <td class="align-middle">
