            ...
            <div class="table-responsive p-0">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <div>
                            <img src="{{ asset('dash') }}/assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user1">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ asset('dash') }}/assets/img/team-3.jpg" class="avatar avatar-sm me-3" alt="user2">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ asset('dash') }}/assets/img/team-4.jpg" class="avatar avatar-sm me-3" alt="user3">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                        <div>
                            <img src="{{ asset('dash') }}/assets/img/team-2.jpg" class="avatar avatar-sm me-3" alt="user5">
                        </div>
                        <div class="d-flex flex-column justify-content-center">
