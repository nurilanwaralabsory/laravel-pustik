        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Book Detail</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Book Detail</h6>
            </nav>
                                ...
                                <table class="table align-items-center mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-0">:</td>
                                            <td>
                                                <h6 class="d-inline-block mb-0 text-sm">{{ $buku->description }}</h6>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
