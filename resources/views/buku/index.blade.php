    ...
    <div class="row mt-4">
        ...
        <div class="card mb-4">
            <div class="card-header pt-4 pb-2">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-warning mb-0" href="javascript:;"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New Book</a>
                    </div>
                  </div>
            </div>
            ...
            <div class="table-responsive p-0">
                ...
                <thead>
                    <tr>
                    <th style="min-width: 10px!important" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">#</th>
                    ...
                    @foreach ($book as $buku)
                        <tr>
                            <td style="width: 5%!important">
                                <p style="width: 5%!important" class="text-xs font-weight-bold mb-0">{{ $no++ }}</p>
                            ...
                            <td class="align-middle">
                                <a class="btn btn-link text-primary text-gradient px-1 mb-0" href="javascript:;"><i class="far fa-eye me-2"></i>Detail</a>
                                <a class="btn btn-link text-dark px-1 mb-0" href="javascript:;"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                                <a class="btn btn-link text-danger text-gradient px-1 mb-0" href="javascript:;"><i class="far fa-trash-alt me-2"></i>Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                            <div>
                                <img src="{{ asset('dash') }}/assets/img/team-4.jpg" class="avatar avatar-sm me-3" alt="user6">
                            </div>
                            <div class="d-flex flex-column justify-content-center">
