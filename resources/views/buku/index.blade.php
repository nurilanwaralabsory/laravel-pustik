                ...
                <div class="ms-md-auto pt-2 pe-md-3 d-flex align-items-center">
                    <form class="d-flex" role="search" action="{{ route('buku.index') }}" method="GET">
                        <div class="input-group">
                            ...
                            <input class="form-control me-1" type="search" name="search" placeholder="Cari Buku..."
                                aria-label="Search">
                            <div class="">
                                <button class="btn bg-gradient-warning mb-0"><i
                ...
                <div class="card-header pt-4 pb-2">
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <a class="btn bg-gradient-warning mb-0" href="{{ route('buku.create') }}"><i
                                    class="fas fa-plus"></i>&nbsp;&nbsp;Add New Book</a>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach ($book as $buku)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ $buku->publisher }}</span>
                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $buku->category->category_name }}
                                            </p>
                                            {{-- <p class="text-xs text-secondary mb-0">Developer</p> --}}
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <a class="btn btn-link text-primary text-gradient px-1 mb-0"
                                                href="{{ route('buku.show', $buku->id) }}"><i
                                                    class="far fa-eye me-2"></i>Detail</a>
                                            <a class="btn btn-link text-dark px-1 mb-0"
                                                href="{{ route('buku.edit', $buku->id) }}"><i
                                            ...
                                            <form action="{{ route('buku.destroy', $buku->id) }}" method="POST"
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-link text-danger px-1 text-gradient mb-0 "
