                ...
                <form action="{{ route('buku.store') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                    name="judul" placeholder="Judul Buku" aria-label="Judul Buku"
                                    aria-describedby="Judul Buku-addon">
                                @error('judul')
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('penulis') is-invalid @enderror"
                                    name="penulis" placeholder="Penulis" aria-label="Penulis"
                                    aria-describedby="Penulis-addon">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('penerbit') is-invalid @enderror"
                                    name="penerbit" placeholder="Penerbit" aria-label="Penerbit"
                                    aria-describedby="Penerbit-addon">
                                <!-- Penyesuaian validasi -->
                                @error('penerbit')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-3">
                                <input class="form-control @error('sampul') is-invalid @enderror" name="sampul"
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('isbn') is-invalid @enderror"
                                    name="isbn" placeholder="ISBN" aria-label="isbn" aria-describedby="isbn-addon">
                                <!-- Penyesuaian validasi -->
                                @error('isbn')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="mb-3">
                        <textarea type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi"
                            placeholder="Deskripsi" aria-label="Deskripsi" aria-describedby="Deskripsi-addon"></textarea>
                        <!-- Penyesuaian validasi -->
                        @error('deskripsi')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
