        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark" aria-current="page"><a class="opacity-5 text-dark"
                            href="{{ route('buku.index') }}">Books</a></li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Book Edit</li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Book Edit</h6>
            </nav>
                    ...
                    <li class="nav-item dropdown pe-1 d-flex align-items-center">
                        ...
                        <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4"
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                <li class="mb-2" :href="route('logout')"
        ...
        <div class="card card-white">
            <div class="card-header pb-0 bg-transparent">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        <a class="btn bg-gradient-warning mb-0" href="{{ route('buku.index') }}"><i
            ...
            <div class="card-body">
                <form action="{{ route('buku.update', $buku->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                    value="{{ $buku->title }}" name="judul" placeholder="Judul Buku"
                                    aria-label="Judul Buku" aria-describedby="Judul Buku-addon">
                                @error('judul')
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('penulis') is-invalid @enderror"
                                    value="{{ $buku->author }}" name="penulis" placeholder="Penulis"
                                    aria-label="Penulis" aria-describedby="Penulis-addon">
                            ...
                            <div class="mb-3">
                                <select class="form-select @error('kategori') is-invalid @enderror" value=""
                                    name="kategori" aria-label="Default select example">
                                    <option selected hidden></option>
                                    @foreach ($category as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $buku->category_id == $item->id ? 'selected' : '' }}>
                        ...
                        <div class="col">
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('penerbit') is-invalid @enderror"
                                    value="{{ $buku->publisher }}" name="penerbit" placeholder="Penerbit"
                                    aria-label="Penerbit" aria-describedby="Penerbit-addon">
                                <!-- Penyesuaian validasi -->
                                @error('penerbit')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <label>Sampul Buku<small class="text-danger ms-1">*</small><small class="text-danger">
                                    @if ($buku->cover != '')
                                        Kosongkan jika tidak mengubah gambar
                                    @endif
                                </small></label>
                            <div class="mb-3">
                                <input class="form-control @error('sampul') is-invalid @enderror" value=""
                                    name="sampul" type="file" id="formFile">
                                @error('sampul')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('isbn') is-invalid @enderror"
                                    value="{{ $buku->isbn }}" name="isbn" placeholder="ISBN" aria-label="isbn"
                    ...
                    <div class="mb-3">
                        <textarea type="text" class="form-control @error('deskripsi') is-invalid @enderror" value=""
                            name="deskripsi" placeholder="Deskripsi" aria-label="Deskripsi" aria-describedby="Deskripsi-addon">{{ $buku->description }}</textarea>
                        <!-- Penyesuaian validasi -->
                        @error('deskripsi')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0"><i
                                class="fas fa-plus"></i>&nbsp;&nbsp; Update Book</button>
                    </div>
                </form>
            </div>
        </div>
